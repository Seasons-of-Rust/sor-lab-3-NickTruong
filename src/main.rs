...
impl Shop {
    ...
    fn most_expensive(&self) -> u32 {
        let mut most_expensive_price = 0;
        for card in &self.cards {
            if card.price > most_expensive_price {
                most_expensive_price = card.price;
            }
        }
    ...
    fn total_damage(&self) -> u32 {
        let mut total_damage_value: u32 = 0;
        for card in &self.cards {
            total_damage_value += card.damage;
        }
        total_damage_value
    }
    ...
    fn total_health(&self) -> u32 {
        let mut total_health_value: u32 = 0;
        for card in &self.cards {
            total_health_value += card.health;
        }
        total_health_value
    }
}
